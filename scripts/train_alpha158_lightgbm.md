# Usage Guide: `train_alpha158_lightgbm.py`
...
2. Validates and loads the Russell 1000 instrument universe.
3. Computes the 158-factor technical feature set (`Alpha158`) across historical daily bars.
